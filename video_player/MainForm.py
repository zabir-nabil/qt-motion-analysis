...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bottomImage.setMinimumSize(QtCore.QSize(0, 20))
        self.bottomImage.setMaximumSize(QtCore.QSize(16777215, 30))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Motion Analysis Tool"))
        self.timeComboBox.setItemText(1, _translate("MainWindow", "Real-Time"))
        self.timeComboBox.setItemText(0, _translate("MainWindow", "Frame by Frame"))
        self.fileButton.setText(_translate("MainWindow", "Open Video File"))
        self.openButton.setText(_translate("MainWindow", "Process Frame"))
